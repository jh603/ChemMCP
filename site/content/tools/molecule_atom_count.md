...
Output:
```yaml
atom_counts: "There are altogether 3 atoms (omitting hydrogen atoms). The types and corresponding numbers are: {'C': 2, 'O': 1}"
```
...
```JSON
{
    ...
    "args": ["--directory", "/ABSTRACT/PATH/TO/ChemMCP", "run", "-m", "chemmcp.tools.molecule_atom_count"],
...
| --- | --- | --- |
| atom_counts | str | A description of atom numbers in the molecule. |
